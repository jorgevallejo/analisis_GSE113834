...
En el estudio primero se estableció qué genes presentaban cambios significativos entre las muestras WASH y las muestras ELUTED. Y se comprobó si esos cambios genes eran los mismos en sujetos con la condición CONTROL y sujetos con la condición ASD.

Para replicar ese razonamiento, hemos organizado la matriz de contrastes de la siguiente manera:

WASH vs ELUTED en CONTROL
WASH vs ELUTED en ASD
